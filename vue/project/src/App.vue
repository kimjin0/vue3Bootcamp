...
-->
  ...
  <nav v-if="examGb == 'binding'">
    <router-link to="/3_tutorial/2">선언적 렌더링</router-link> | <router-link to="/3_tutorial/3">속성 바인딩</router-link> | <router-link to="/3_tutorial/4">이벤트 리스터</router-link> |
    <router-link to="/3_tutorial/5">form 바인딩</router-link> | <router-link to="/3_tutorial/6">조건부 렌더링</router-link> | <router-link to="/3_tutorial/7">리스트 렌더링</router-link> |
    <router-link to="/3_tutorial/8">계산된 속성</router-link> | <router-link to="/3_tutorial/9">수명주기와 템플릿 참조</router-link> | <router-link to="/3_tutorial/10">감시자</router-link> |
    <router-link to="/3_tutorial/11">컴포넌트 & Props</router-link> | <router-link to="/3_tutorial/13">컴포넌트 & Emits</router-link> |
    <router-link to="/3_tutorial/14">슬롯</router-link>
  </nav>
  <nav v-if="examGb == 'exam'">
    <router-link to="/4_examples/HandingInput">사용자 입력 핸들링</router-link> | <router-link to="/4_examples/AttributeBindings">속성 바인딩</router-link> |
    <router-link to="/4_examples/ConditionalsAndLoops">조건문과 반복문</router-link> | <router-link to="/4_examples/FormBindings">form 바인딩</router-link> |
    <router-link to="/4_examples/SimpleComponent">단순한 컴포넌트</router-link> | <router-link to="/4_examples/FetchingData">데이터 가져오기</router-link> |
    <router-link to="/4_examples/TodoMVC">TodoMVC</router-link> |
  </nav>
  <nav v-if="examGb == 'exam'">
